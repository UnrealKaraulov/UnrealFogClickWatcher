...
namespace war3 {
	...
	struct CSelectionWar3 {
		...
		unsigned int		unk_1B0[4];
		UnitList*			activeSubgroupSync;	//0x1C0
	...
	struct CBulletBase {
		...
		unsigned int unk_60;					//0x60	flag，值通常=00 01 00 00，第一个byte改为0xFF会无伤害	TODO 研究一下攻击miss与暴击
